...
This workspace provides a Node.js implementation for managing Authelia file-based authentication users.
...
- One `docker-compose.yml` to run Node services
...
It builds and pushes Node backend/frontend images to GHCR on pushes to main or when manually triggered.
